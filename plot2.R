...
## step 5: Creat plot 2
png("plot2.png", width=480, height=480) # Open PNG device; create 'plot2.png' in my working diretory
...
#Option: with(data1, plot(Global_active_power~Datetime, type="l", ylab="Global Active Power (kilowatts)", xlab=""))
